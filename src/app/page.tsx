...
export default function HomePage() {
  ...
  return (
    <>
      <div className="flex h-[calc(100vh-128px)] flex-col items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-4">
            <TicketIcon className="mx-auto h-12 w-12 text-primary" />
            <h1 className="mt-2 text-3xl font-bold">AppShade Support</h1>
          ...
          <Card className="mb-3">
            <CardHeader className="pb-3">
              <CardTitle>Bienvenue sur notre plateforme</CardTitle>
              <CardDescription>
                {isSignedIn 
            ...
            <CardFooter className="text-center text-sm text-muted-foreground pt-0">
              {isSignedIn 
                ? "Accédez à votre espace personnel pour gérer vos tickets"
                : "Créez un compte ou connectez-vous pour accéder à la plateforme"}
            </CardFooter>
          </Card>
          
          {/* Logo section */}
          <div className="text-center">
            <p className="text-sm text-muted-foreground mb-1">Propulsé par</p>
            <div className="flex justify-center items-center gap-3">
              ...
              <Image 
                src="/images/logos/react-dark.svg" 
                alt="React Logo" 
                width={40} 
                height={40} 
                className="ml-1"
